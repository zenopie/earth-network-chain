module github.com/earth-network/earth

go 1.25.10

replace (
	github.com/burnt-labs/barretenberg-go => ./third_party/barretenberg-go
...
require (
	// Pinned deliberately. wasmd carries a stray v1.0.0 tag from 2019 (Cosmos SDK
	// v0.36, no x/wasm package at that path), and semver ranks it above the real
	// releases, so `go get -u` or a tidy that drops this line resolves @latest to
	// a module that does not compile. Bump only to an explicit v0.6x version.
	github.com/CosmWasm/wasmd v0.61.14
	github.com/burnt-labs/barretenberg-go v0.0.0-00010101000000-000000000000
