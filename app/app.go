...
func New(
	...
	// Register upgrade handlers and, when restarting into a pending upgrade,
	// install the store loader that applies its StoreUpgrades. Must precede
	// Load: the store loader has to be set before the multistore is read.
	// See app/upgrades.go.
	app.setupUpgrades()
