...
type Params struct {
	...
	// network_daily_registration_floor and network_daily_registration_growth_bps
	// bound registrations across the whole network in a day:
	//
	//	cap = max(floor, growth_bps * yesterday's network registrations / 10000)
	//
	// The per-signer and per-country caps each bound one source, and together
	// they bound nothing: every country in the trust store has its own full
	// allowance, so several compromised roots at once — or one root issuing
	// under many country codes — add up without limit. This is the ceiling on
	// the sum. Growth rather than share, since the network is the whole: 30000
	// lets a day triple the one before, which real adoption can do and a
	// sudden flood of forged registrations is shaped like. Zero on either falls
	// back to the default.
	NetworkDailyRegistrationFloor     uint64 `protobuf:"varint,21,opt,name=network_daily_registration_floor,json=networkDailyRegistrationFloor,proto3" json:"network_daily_registration_floor,omitempty"`
	NetworkDailyRegistrationGrowthBps uint64 `protobuf:"varint,22,opt,name=network_daily_registration_growth_bps,json=networkDailyRegistrationGrowthBps,proto3" json:"network_daily_registration_growth_bps,omitempty"`
}
...
func (m *Params) GetNetworkDailyRegistrationFloor() uint64 {
	if m != nil {
		return m.NetworkDailyRegistrationFloor
	}
	return 0
}

func (m *Params) GetNetworkDailyRegistrationGrowthBps() uint64 {
	if m != nil {
		return m.NetworkDailyRegistrationGrowthBps
	}
	return 0
}
...
var fileDescriptor_5658283c6f146ef1 = []byte{
	...
	,
}
...
func (this *Params) Equal(that interface{}) bool {
	...
	if this.NetworkDailyRegistrationFloor != that1.NetworkDailyRegistrationFloor {
		return false
	}
	if this.NetworkDailyRegistrationGrowthBps != that1.NetworkDailyRegistrationGrowthBps {
		return false
	}
	return true
}
...
func (m *Params) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.NetworkDailyRegistrationGrowthBps != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.NetworkDailyRegistrationGrowthBps))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb0
	}
	if m.NetworkDailyRegistrationFloor != 0 {
		i = encodeVarintParams(dAtA, i, uint64(m.NetworkDailyRegistrationFloor))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa8
...
func (m *Params) Size() (n int) {
	...
	if m.NetworkDailyRegistrationFloor != 0 {
		n += 2 + sovParams(uint64(m.NetworkDailyRegistrationFloor))
	}
	if m.NetworkDailyRegistrationGrowthBps != 0 {
		n += 2 + sovParams(uint64(m.NetworkDailyRegistrationGrowthBps))
	}
	return n
}
...
func (m *Params) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 21:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NetworkDailyRegistrationFloor", wireType)
			}
			m.NetworkDailyRegistrationFloor = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NetworkDailyRegistrationFloor |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 22:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NetworkDailyRegistrationGrowthBps", wireType)
			}
			m.NetworkDailyRegistrationGrowthBps = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowParams
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NetworkDailyRegistrationGrowthBps |= uint64(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
